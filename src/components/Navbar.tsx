...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white sticky top-0 z-50 transition-colors duration-200">
