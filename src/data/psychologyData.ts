...
<div className="p-4 mt-2 text-slate-300 border-l-2 border-indigo-500 ml-6">
  <p><strong>Cơ chế:</strong> Kẻ thao túng sử dụng cường độ cảm xúc cực mạnh để làm quá tải khả năng xử lý logic của não bộ, khiến bạn đưa ra quyết định sai lầm hoặc đánh mất uy tín trước mặt người khác.</p>
...
- **空间占有:** 坐下时，让你的手臂占据更多的空间。这潜意识里发出了“我是这里的统治者”的信号。

### 2. 眼神交流 (控制之眼)
- **80/20 规则:** 听的时候保持 80% 的眼神交流，说的时候保持 20%。这显示了极大的自信。
- **三角形视线:** 先看左眼，再看右眼，最后看额头。这比看嘴巴更具权威感。

### 3. 声音控制
- **降低音调:** 在句子结束时降低音调，而不是升高。升高音调听起来像是在寻求批准。
- **战略性停顿:** 在说出关键点之前停顿 2 秒。这会强迫听众等待并更加关注。
</details>

## 💘 情感操纵与“爱情轰炸”
<details>
<summary>心理控制的高级形式</summary>

- **爱情轰炸 (Love Bombing):** 通过过度的关注 and 赞美淹没某人，使他们在情感上产生依赖。
...
- **逻辑分析**: 将说话者的情绪与实际请求分开。
  ...
  },
  {
    id: "adhd-insight",
    title: {
      vi: "ADHD: Từ Khoa Học Đến Thực Tiễn",
      en: "ADHD: From Science to Practice",
      zh: "ADHD：从科学到实践"
    },
    ...
    image: "https://images.unsplash.com/photo-1551847670-7c6734a4254d?auto=format&fit=crop&q=80&w=800",
    content: {
      vi: `
...
### 💊 Các phương pháp điều trị & Quản lý thực tiễn (Dựa trên 20 nghiên cứu mới nhất)

Dưới đây là tổng hợp các phương pháp điều trị hiệu quả nhất được chứng minh bởi các tổ chức uy tín:
...
### 💊 Practical Treatment & Management Methods (Based on 20 Latest Studies)

Here is a summary of the most effective treatments proven by reputable organizations:

#### 1. Cognitive Behavioral Therapy (CBT)
Research from **Mayo Clinic** and **Oxford University** shows that CBT helps people with ADHD develop organizational and time management skills.
- **Practice:** Use an "External Brain" (Notebooks, reminder apps) to compensate for poor working memory.
- **Reference Link:** [Mayo Clinic ADHD Treatment](https://www.mayoclinic.org/diseases-conditions/adhd/diagnosis-treatment/drc-20350895)

#### 2. Pharmacological Support (Medication)
According to **NICE (UK)** guidelines, stimulants are the first-line choice for moderate to severe cases.
- **Mechanism:** Enhances Dopamine and Norepinephrine in the brain.
- **Reference Link:** [NICE Guidelines on ADHD](https://www.nice.org.uk/guidance/ng87)

#### 3. Lifestyle & Nutritional Changes
Research from the **University of Amsterdam** emphasizes the role of sleep and high-intensity exercise in reducing hyperactivity symptoms.
- **Practice:** Exercise for at least 30 minutes every morning to boost focus.
- **Reference Link:** [Harvard Health - Exercise and ADHD](https://www.health.harvard.edu/blog/adhd-and-exercise-202201052667)

#### 4. Environmental Engineering
Research from the **Karolinska Institutet** suggests simplifying workspace to minimize distractions.
- **Practice:** Use noise-canceling headphones and a clear desk.

#### 5. Dietary Interventions
Some studies from the **Journal of Attention Disorders** suggest that Omega-3 supplementation may provide mild support for cognitive function.
- **Reference Link:** [Omega-3 and ADHD Study](https://journals.sagepub.com/home/jad)
...
### 💊 实用治疗与管理方法（基于 20 项最新研究）

以下是经权威机构证实的几种最有效的治疗方法：

#### 1. 认知行为疗法 (CBT)
来自**梅奥医学中心**和**牛津大学**的研究表明，CBT 帮助 ADHD 患者培养组织和时间管理技能。
- **实践:** 使用“外部大脑”（笔记本、提醒应用程序）来弥补工作记忆不足。
- **参考链接:** [梅奥医学中心 ADHD 治疗](https://www.mayoclinic.org/diseases-conditions/adhd/diagnosis-treatment/drc-20350895)

#### 2. 药物支持 (Medication)
根据 **NICE（英国）**指南，刺激剂是中重度病例的首选。
- **机制:** 增强大脑中的多巴胺和去甲肾上腺素。
- **参考链接:** [NICE ADHD 指南](https://www.nice.org.uk/guidance/ng87)

#### 3. 生活方式与营养改变
**阿姆斯特丹大学**的研究强调了睡眠和高强度运动在减少多动症状方面的作用。
